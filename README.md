...
```
java -Dspring.profiles.active=production -jar ./target/SpringBatchProject-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify/spring-batch-project
```

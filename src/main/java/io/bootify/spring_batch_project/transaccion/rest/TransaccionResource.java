package io.bootify.spring_batch_project.transaccion.rest;
...
public class TransaccionResource {
    ...
    public ResponseEntity<Integer> createTransaccion(
        ...
        final Integer createdId = transaccionService.create(transaccionDTO);
        return new ResponseEntity<>(createdId, HttpStatus.CREATED);
    }

    @PutMapping("/{id}")
    public ResponseEntity<Integer> updateTransaccion(@PathVariable(name = "id") final Integer id,
            @RequestBody @Valid final TransaccionDTO transaccionDTO) {
    ...
    public ResponseEntity<Void> deleteTransaccion(@PathVariable(name = "id") final Integer id) {
